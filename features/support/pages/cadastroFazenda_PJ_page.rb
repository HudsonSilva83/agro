class CadastroFazenda_PessoaJuridica < SitePrism::Page
...
#Campos para cálculo de venda
   ...
   def preencherCampos(valor)
            ...
            @valor = valor
            campo_nome.set 'Automacao_Pessoa_Jurídica'
            ...
            observacoes.set 'Teste Automação AgroHub, Cadastro Fazenda - Pessoa Juridica'
            ...
            #selecionando duração do periodo chuvoso "De"
